...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <h2 className="text-xl font-semibold">7. Changes to Services and Pricing</h2>
      <p>
      ...
      <p>
        ...
        State of Arizona, United States, without regard to its conflict of law
        provisions. Any disputes arising from these Terms will be subject to the
        exclusive jurisdiction of the state or federal courts located in Arizona, USA.
      </p>
